...
class ReviewRoundSeeder extends Seeder
{
    ...
    private const FUNCTIONS = [
        ...
        'evaluations-person-results' => 'เทียบคำตอบทุกรอบของคนเดียว · แนวโน้มดีขึ้น/ลดลง',
        'evaluations-summary' => 'รายงานวิจัยรายแบบประเมิน · ตารางความถี่ x̄ S.D. · กราฟเปลี่ยนแปลง · ส่งออก CSV',
        'evaluations-analysis' => 'ภาพรวมโครงการ · โดนัทกลุ่มเป้าหมาย · การตอบรายรอบ · ก่อน–หลัง',
