...
class Activity extends Model
{
    ...
    /**
     * กิจกรรมทั่วไป — บังคับกรอกแค่ชื่อ ที่เหลือกรอกหรือไม่ก็ได้แม้ตอนเผยแพร่
     *
     * มีไว้สำหรับงานที่ไม่ใช่กิจกรรมตามตาราง เช่น "สอบถามการเยี่ยมชมสวน"
     * ซึ่งไม่มีวันจัด ไม่มีรอบ ไม่มีวิทยากร แต่ยังต้องเปิดรับข้อมูลจากผู้สนใจได้
     * ถ้าใช้ประเภทกิจกรรมปกติจะติดเงื่อนไขบังคับกรอกที่ไม่มีอยู่จริงกับงานแบบนี้
     */
    public const TYPE_GENERAL = 'ทั่วไป';
