...
2. **ตัวกรอง "ประเภท"** — ใช้ฟิลด์ `participantType` (กลุ่มตัวอย่าง/ทั่วไป) แยกจากฟิลด์ `type` (กิจกรรม/อีเว้นท์) ในฟอร์ม
...
## Master Data (อ้างอิง Dataset จริง — dataset.pdf 8 ส.ค. 2569)

ค่าทั้งหมดใน `mock-data.js` ถูกปรับให้ตรงกับ Dataset ที่ทีมงานให้มาแล้ว

| ชุดข้อมูล | ค่า |
|---|---|
| พื้นที่ดำเนินงาน | The Farm Concept (เขตบางนา, พื้นที่ต้นแบบ) · ชุมชนพูนทรัพย์ (เขตสายไหม, ส่วนขยาย) · ชุมชนตึกร้าง (เขตบางพลัด, ส่วนขยาย) — ทั้งหมดทำงานร่วมกับ สสส. พลเมืองอาสา |
| ประเภทพื้นที่ | เอกชน / ชุมชน-หมู่บ้าน / โรงเรียน / สถานประกอบการเอกชน / โรงพยาบาล |
| กลุ่มพื้นที่ | พื้นที่ต้นแบบ / พื้นที่ต้นแบบส่วนขยาย / พื้นที่จัดกิจกรรม |
| กลุ่มเป้าหมาย (เป้าจำนวนคน) | เด็กและเยาวชน 5,000 · วัยทำงาน 2,000 · ผู้สูงอายุ 1,000 · กลุ่มเปราะบาง 1,000 (ฟิลด์ `targetCount`) |
| โปรแกรม/หลักสูตร | 4 โปรแกรม × 4 หลักสูตร: กินดี อยู่ดี / ปลูกกินเอง / Food Literacy / ครัวสุขภาวะ |
| วิทยากร | 5 คน (ดร.กิตติพงศ์, อ.พิมพ์ชนก, คุณภูริณัฐ, คุณกัญญารัตน์, คุณปกรณ์ชัย) |
| รูปแบบกิจกรรม | CRAFT / MIND / FOOD / WORKSHOP / COMMUNITY |
| รอบติดตามกลุ่มตัวอย่าง | 3 / 6 / 12 เดือน |
| ประเภทกิจกรรม | กิจกรรม / อีเว้นท์ |
| ประเภทผู้เข้าร่วม | กลุ่มตัวอย่าง / กลุ่มทั่วไป |

หมายเหตุจาก Dataset: **ประเภทพื้นที่ / กลุ่มพื้นที่ / ประเภทกิจกรรม / ประเภทผู้เข้าร่วม ไม่ต้องมีหน้าจอจัดการ**
(อนาคตจะดึงจากฐานข้อมูลโดยตรง) — ตอนนี้เก็บเป็น master list ใน `mock-data.js` และให้ฟอร์ม/ตัวกรองอ่านไปใช้
