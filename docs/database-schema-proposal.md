...
|---|---|---|
| กลุ่มเป้าหมาย | ย้ายแล้ว | `TG-` · ลบไม่ได้ถ้ามีกิจกรรมหรือผู้เข้าร่วมอ้างอิง |
| หมวดหมู่กิจกรรม | ย้ายแล้ว | `FMT-` · ไอคอนตรวจกับ `config('farmconcept.category_icons')` |
| วิทยากร | ยังไม่ย้าย | มีรูปโปรไฟล์ · ความเชี่ยวชาญ · หลักสูตรที่สอน (สองตารางลูก) |
| พื้นที่ดำเนินงาน | ยังไม่ย้าย | ฟิลด์เยอะที่สุด · ผูกกับ `mst_districts` |
| โปรแกรม/หลักสูตร | ยังไม่ย้าย | หลักสูตรซ้อนอยู่ในโปรแกรม แก้พร้อมกันในโมดัลเดียว |
| ตั้งค่ารอบติดตาม | ยังไม่ย้าย | ไม่ใช่ CRUD ทีละแถว — แก้ทั้งตารางแล้วกดบันทึกครั้งเดียว ต้องมี endpoint แบบ bulk |

หน้า static เดิมของสองตารางที่ย้ายแล้วยังอยู่ที่ `admin/basic/*.html` และยังเปิดได้
(ทำงานกับข้อมูลจำลองเหมือนเดิม) เมนูซ้ายชี้หน้าใหม่แล้ว จะลบไฟล์เก่าเมื่อย้ายครบทั้งหกตาราง
