...
@section('content')
    ...
    <section class="detail-card tr-card">
        ...
        @if($lineEnabled)
            ...
            {{-- โหมดเชื่อมบัญชี ปุ่มนี้เป็นทางสำรอง — ทางหลักคือสคริปต์ LIFF ด้านล่างที่เชื่อมให้เอง
                 เมื่อหน้าถูกเปิดในแอป LINE ปุ่มนี้มีไว้เผื่อเปิดจากเบราว์เซอร์ปกติ ซึ่งต้องผ่าน OAuth --}}
