    ...
    <section class="detail-card tr-card">
        <div class="tr-done">
            ...
            {{-- กลับแดชบอร์ดของระบบติดตาม ไม่ใช่หน้าหลักของเว็บ — คนที่ตอบรอบนี้ยังมีรอบอื่น
                 ...
                 ยกเว้นตอนกรอกแทน — แดชบอร์ดแสดงรอบของ "ผู้กรอก" ไม่ใช่ของผู้ถูกประเมิน
                 กดปุ่มนี้ไปแล้วกด "เริ่มทำ" ต่อจะได้ 404 เพราะหน้าทำแบบประเมินยึดผู้ถูกประเมินอยู่
                 พากลับไปที่รอบของผู้ถูกประเมินแทน ซึ่งเป็นงานที่ยังทำค้างอยู่จริง --}}
            @if($proxyFor)
                <a class="tr-primary-button" href="{{ route('public.tracking-round-qr.rounds') }}">
                    กลับไปที่รอบของ {{ $proxyFor->name }}
                </a>
            @else
