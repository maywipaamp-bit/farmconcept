  ...
  function subnavHtml() {
    ...
    return '<div class="subnav" id="app-subnav">' +
      ...
      '<div class="subnav-foot">' +
        /* คู่มืออยู่ที่ public/manual/ เสิร์ฟเป็นไฟล์สแตติก เปิดได้โดยไม่ต้องล็อกอิน
           เปิดแท็บใหม่เพราะคนมักเปิดคู่มือค้างไว้แล้วสลับกลับมาทำงานต่อ */
        '<a class="subnav-foot-link" href="' + base + 'manual/index.html" target="_blank" rel="noopener">' + itemIcon(ICON.help) + '<span>คู่มือการใช้งาน</span></a>' +
